    ...
    if (isMobile && navigator.share) {
      try {
        const vCardData = [
          ...
          'NOTE:Crio sites e sistemas que ajudam empresas a atrair e reter mais clientes através da sua estrutura própria.',
          'END:VCARD'
        ].join('\r\n');
          ...
          <motion.section variants={itemVariants} className="flex flex-col items-center text-center gap-6">
            ...
            <div className="space-y-6 px-2">
              ...
              <p className="text-white/60 text-base leading-relaxed font-medium">
                Como Webdesigner, crio sites e sistemas sob medida para ajudar empresas a atrair e reter mais clientes qualificados, através da sua estrutura própria.
              </p>
            </div>
          </motion.section>
